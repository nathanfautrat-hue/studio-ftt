          ...
          <div>
            ...
            <Reveal delay={3}>
              <p style={{ fontSize: 15, lineHeight: 1.7, color: "var(--ftt-text-mid)", margin: "0 0 28px" }}>
                Pour votre cabinet, je peux préparer la même chose, avec vos
                spécialités et votre ville, et vous la montrer en visio. Sans
                engagement : si ça ne vous parle pas, on en reste là.
              </p>
            </Reveal>
            <Reveal delay={3}>
              <a href={siteConfig.calendly} target="_blank" rel="noopener noreferrer" className="btn btn--solid">
                Voir la mienne en visio <span className="btn__arrow">→</span>
              </a>
            </Reveal>
          </div>
          <Reveal delay={2}>
