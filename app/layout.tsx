...
const DESCRIPTION =
  "Création de site internet en Sarthe et au Mans. Sites sur-mesure pour artisans et PME — livrés en 14 jours ouvrés, à partir de 500 €. SEO local inclus.";
      ...
      <body>
        ...
        <Script id="ga4-init" strategy="afterInteractive">
          {`
            ...
            window.gtag('config', 'G-V3KDDW3PJY', {
